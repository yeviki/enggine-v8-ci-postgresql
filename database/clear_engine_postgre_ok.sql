...
-- ----------------------------
INSERT INTO "public"."xi_sa_users" VALUES (2, '4A3729CA5A1593D72E67FF0FE31185D1', 0, '', 'viki', '$2a$12$M1H99hjaWjQr1FzH1Q6ECOtU1RPu/qnmYOMGvqWX9TrzGY8nhLh7S', '', 'Prima Aulia', 'default-user-icon.jpg', 0, 1, '', 0, '', 0, 0, 'yogisolop', '2020-12-23 09:18:01', '::1', 'viki', '2022-01-25 11:18:37', '127.0.0.1');
...
SELECT setval('"public"."ac_xi_sa_log_session"', 2, true);
...
ALTER TABLE "public"."xi_sa_group_privileges" ADD CONSTRAINT "groupPrevilegesToRules" FOREIGN KEY ("id_rules") REFERENCES "public"."xi_sa_rules" ("id_rules") ON DELETE RESTRICT ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table xi_sa_log_session
-- ----------------------------
ALTER TABLE "public"."xi_sa_log_session" ADD CONSTRAINT "logSessionToUsers" FOREIGN KEY ("id_users") REFERENCES "public"."xi_sa_users" ("id_users") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table xi_sa_rules
-- ----------------------------
ALTER TABLE "public"."xi_sa_rules" ADD CONSTRAINT "rulesToFungsi" FOREIGN KEY ("id_fungsi") REFERENCES "public"."xi_sa_fungsi" ("id_fungsi") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "public"."xi_sa_rules" ADD CONSTRAINT "rulesToKontrol" FOREIGN KEY ("id_kontrol") REFERENCES "public"."xi_sa_kontrol" ("id_kontrol") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "public"."xi_sa_rules" ADD CONSTRAINT "rulesToModule" FOREIGN KEY ("id_module") REFERENCES "public"."xi_sa_module" ("id_module") ON DELETE RESTRICT ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table xi_sa_users_default_pass
-- ----------------------------
ALTER TABLE "public"."xi_sa_users_default_pass" ADD CONSTRAINT "defaultPasstoUsers" FOREIGN KEY ("id_users") REFERENCES "public"."xi_sa_users" ("id_users") ON DELETE CASCADE ON UPDATE CASCADE;

-- ----------------------------
-- Foreign Keys structure for table xi_sa_users_privileges
-- ----------------------------
ALTER TABLE "public"."xi_sa_users_privileges" ADD CONSTRAINT "whiteToGroup" FOREIGN KEY ("id_group") REFERENCES "public"."xi_sa_group" ("id_group") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "public"."xi_sa_users_privileges" ADD CONSTRAINT "whiteToUsers" FOREIGN KEY ("id_users") REFERENCES "public"."xi_sa_users" ("id_users") ON DELETE CASCADE ON UPDATE CASCADE;
