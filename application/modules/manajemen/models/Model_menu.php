...
class Model_menu extends CI_Model {
    ...
    public function insertDataMenu() {
        ...
        $is_parent   = escape($this->input->post('is_parent', TRUE)) ? escape($this->input->post('is_parent', TRUE)) : '0';
        $order_menu  = escape($this->input->post('order_menu', TRUE));
        $parent_id  = escape($this->input->post('parent_id', TRUE)) ? escape($this->input->post('parent_id', TRUE)) : '0';
